...
@section('content')
    ...
    <!-- Divider Section-->
    <section style="background: url({{ asset('lib/distribution/img/divider-bg.jpg') }});" class="divider">
      <div class="container"> 
        <div class="row">
          <div class="col-lg-6">
            <p>Old Collection                  </p>
        ...
        <div class="row team">
          <div class="col-md-3 col-6">
            <div class="team-member">
                <div class="image"><img src="{{ asset('lib/distribution/img/person-1.jpg') }}" alt="" class="img-fluid rounded-circle"></div>
          ...
          <div class="col-md-3 col-6">
            <div class="team-member">
                <div class="image"><img src="{{ asset('lib/distribution/img/person-2.jpg') }}" alt="" class="img-fluid rounded-circle"></div>
          ...
          <div class="col-md-3 col-6">
            <div class="team-member">
                <div class="image"><img src="{{ asset('lib/distribution/img/person-3.jpg') }}" alt="" class="img-fluid rounded-circle"></div>
          ...
          <div class="col-md-3 col-6">
            <div class="team-member">
                <div class="image"><img src="{{ asset('lib/distribution/img/person-4.jpg') }}" alt="" class="img-fluid rounded-circle"></div>
