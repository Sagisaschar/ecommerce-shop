          ...
          <div class="row">
            <div class="product-images col-lg-6">
              ...
              <div data-slider-id="1" class="owl-carousel items-slider owl-drag">
                  <div class="item"><img src="{{ asset('images/' . $details[0]->pimage) }}" alt="diamond"></div>
                  <div class="item"><img src="{{ asset('images/' . $details[0]->pimage) }}" alt="diamond"></div>
                  <div class="item"><img src="{{ asset('images/' . $details[0]->pimage) }}" alt="diamond"></div>
                  <div class="item"><img src="{{ asset('images/' . $details[0]->pimage) }}" alt="diamond"></div>
                ...
                <div data-slider-id="1" class="owl-thumbs d-flex align-items-center justify-content-center">
                  <button class="owl-thumb-item"><img src="{{ asset('images/' . $details[0]->pimage) }}" alt="diamond"></button>
                  <button class="owl-thumb-item active"><img src="{{ asset('images/' . $details[0]->pimage) }}" alt="diamond"></button>
                  <button class="owl-thumb-item"><img src="{{ asset('images/' . $details[0]->pimage) }}" alt="diamond"></button>
                  <button class="owl-thumb-item"><img src="{{ asset('images/' . $details[0]->pimage) }}" alt="diamond"></button>
            ...
            <div class="details col-lg-6">
              <div class="d-flex align-items-center justify-content-between flex-column flex-sm-row">
                <ul class="price list-inline no-margin">
                  <li class="list-inline-item current"><b>Price on site: </b>${{ $details[0]->price }}</li>
                  <li class="list-inline-item original">$2800.00</li>
                </ul>
            ...
            <p>{!! $details[0]->article !!}</p>
              ...
              <ul class="CTAs list-inline">
                <li class="list-inline-item">
                    @if (Cart::get($details[0]->id))
                    <button disabled="disabled" type="button" class="btn btn-template wide add-to-cart-btn btn-item"><i class="icon-cart"></i>in cart</button>
                    @else
                    <button data-id="{{ $details[0]->id }}" type="button" class="btn btn-template wide add-to-cart-btn btn-item"><i class="icon-cart"></i>Add to cart</button>
                    @endif
                </li>
              <li class="list-inline-item"><a href="{{ url('shop/checkout') }}" class="btn btn-template-outlined wide">Continue to checkout</a></li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div id="reviews" role="tabpanel" class="tab-pane">
              <div class="row">
                <div class="col-xl-9">
                  ...
                  <div class="col-3 text-center"><img src="{{ asset('images/person-1.jpg') }}" alt="Han Solo" class="review-image"><span class="text-uppercase text-muted text-small">Dec 2018</span></div>
                  ...
                  <div class="row review">
                    <div class="col-3 text-center"><img src="{{ asset('images/person-1.jpg') }}" alt="Luke Skywalker" class="review-image"><span class="text-uppercase text-muted text-small">Dec 2018</span></div>
                    <div class="col-9 review-text">
                  ...
                  <div class="row review">
                    <div class="col-3 text-center"><img src="{{ asset('images/person-1.jpg') }}" alt="Princess Leia" class="review-image"><span class="text-uppercase text-muted text-small">Dec 2018</span></div>
                    <div class="col-9 review-text">
                      <h6>Princess Leia</h6>
                  ...
                  <div class="row review">
                    <div class="col-3 text-center"><img src="{{ asset('images/person-1.jpg') }}" alt="Jabba Hut" class="review-image"><span class="text-uppercase text-muted text-small">Dec 2018</span></div>
                    <div class="col-9 review-text">
                      <h6>Jabba Hut</h6>
                      <div class="mb-2"><i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i>
                      </div>
          ...
          <div class="row">
            ...
            <div class="item col-lg-3">
              <div class="product is-gray">
                <div class="image d-flex align-items-center justify-content-center"><img src="{{asset('images/pd_3.jpg')}}" alt="..." class="img-fluid">
            ...
            <div class="item col-lg-3">
              <div class="product is-gray">
                <div class="image d-flex align-items-center justify-content-center"><img src="{{asset('images/pd_4.jpg')}}" alt="..." class="img-fluid">
                  <div class="hover-overlay d-flex align-items-center justify-content-center">
                    <div class="CTA d-flex align-items-center justify-content-center"><a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a><a href="detail.html" class="visit-product active"><i class="icon-search"></i>View</a><a href="#" data-toggle="modal" data-target="#exampleModal" class="quick-view"><i class="fa fa-arrows-alt"></i></a></div>
                  </div>
                </div>
            ...
            <div class="item col-lg-3">
              <div class="product is-gray">
                <div class="image d-flex align-items-center justify-content-center"><img src="{{asset('images/pd_5.jpg')}}" alt="..." class="img-fluid">
                  <div class="hover-overlay d-flex align-items-center justify-content-center">
                    <div class="CTA d-flex align-items-center justify-content-center"><a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a><a href="detail.html" class="visit-product active"><i class="icon-search"></i>View</a><a href="#" data-toggle="modal" data-target="#exampleModal" class="quick-view"><i class="fa fa-arrows-alt"></i></a></div>
                  </div>
                </div>
            ...
            <div class="item col-lg-3">
              <div class="product is-gray">
                <div class="image d-flex align-items-center justify-content-center"><img src="{{asset('images/pd_6.jpg')}}" alt="..." class="img-fluid">
                  <div class="hover-overlay d-flex align-items-center justify-content-center">
                    <div class="CTA d-flex align-items-center justify-content-center"><a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a><a href="detail.html" class="visit-product active"><i class="icon-search"></i>View</a><a href="#" data-toggle="modal" data-target="#exampleModal" class="quick-view"><i class="fa fa-arrows-alt"></i></a></div>
                  </div>
                </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body"> 
              ...
              <div class="row d-flex align-items-center">
                <div class="image col-lg-5"><img src="{{asset('images/shirt.png')}}" alt="..." class="img-fluid d-block"></div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-xl-8 col-lg-10">
                  <h2 class="text-superbig">Sorry...</h2>
                  <p class="lead">Try to search something like "Diamond" ;)</p>
        ...
        <div class="container">
          <div class="row">
            <div class="product-images col-lg-6">
              ...
              <div class="ribbon-primary text-uppercase">Sale</div>
              <div data-slider-id="1" class="owl-carousel items-slider owl-drag">
                <div class="item"><img src="{{ asset('images/' . $product['pimage']) }}" alt="diamond"></div>
                <div class="item"><img src="{{ asset('images/' . $product['pimage']) }}" alt="diamond"></div>
                <div class="item"><img src="{{ asset('images/' . $product['pimage']) }}" alt="diamond"></div>
                <div class="item"><img src="{{ asset('images/' . $product['pimage']) }}" alt="diamond"></div>
              ...
              <div data-slider-id="1" class="owl-thumbs d-flex align-items-center justify-content-center">
                <button class="owl-thumb-item"><img src="{{ asset('images/' . $product['pimage']) }}" alt="diamond"></button>
                <button class="owl-thumb-item active"><img src="{{ asset('images/' . $product['pimage']) }}" alt="diamond"></button>
                <button class="owl-thumb-item"><img src="{{ asset('images/' . $product['pimage']) }}" alt="diamond"></button>
                <button class="owl-thumb-item"><img src="{{ asset('images/' . $product['pimage']) }}" alt="diamond"></button>
            ...
            <div class="details col-lg-6">
              <div class="d-flex align-items-center justify-content-between flex-column flex-sm-row">
                <ul class="price list-inline no-margin">
                  <li class="list-inline-item current"><b>Price on site: </b>${{ $product['price'] }}</li>
                  <li class="list-inline-item original">$2800.00</li>
                </ul>
                <div class="review d-flex align-items-center">
                  <ul class="rate list-inline">
            ...
            <p>{!! $product['article'] !!}</p>
              ...
              <ul class="CTAs list-inline">
                <li class="list-inline-item">
                    ...
                    <button disabled="disabled" type="button" class="btn btn-template wide add-to-cart-btn btn-item"><i class="icon-cart"></i>in cart</button>
                    @else
                    <button data-id="{{ $product['id'] }}" type="button" class="btn btn-template wide add-to-cart-btn btn-item"><i class="icon-cart"></i>Add to cart</button>
                    @endif
                </li>
              <li class="list-inline-item"><a href="{{ url('shop/checkout') }}" class="btn btn-template-outlined wide">Continue to checkout</a></li>
              </ul>
