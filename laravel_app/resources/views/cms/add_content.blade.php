      ...
      <div class="row">
        ...
        <form action="{{ url('cms/content') }}" method="POST" novalidate="novalidate">
            ...
            <div class="form-group mb-5">
              ...
              <input type="text" name="ctitle" id="title" class="form-control field-input-cms" value="{{ old('ctitle') }}" placeholder="e.g. Our history">
          ...
          <a href="{{ url('cms/content') }}" class="btn btn-outline-danger">Cancel</a>
            <input name="submit" class="btn btn-outline-primary" type="submit" value="Save Content">
          </form>
        </div>
