...
<div id="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <form action="{{ url('cms/products') }}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group mb-5">
              ...
              <input type="text" name="ptitle" id="title" class="form-control field-input-cms original-text" value="{{ old('ptitle') }}" placeholder="e.g. Prestige Diamond">
            ...
            <div class="form-group">
              ...
              <input type="text" name="purl" id="url" class="form-control field-input-cms target-text" value="{{ old('purl') }}" placeholder="e.g. prestige-diamond">
            ...
            <div class="form-group">
                ...
                <input type="text" name="price" id="price" class="form-control field-input-cms" value="{{ old('price') }}" placeholder="e.g. 2300">
          ...
          <a href="{{ url('cms/products') }}" class="btn btn-outline-danger">Cancel</a>
            <input name="submit" class="btn btn-outline-primary" type="submit" value="Save Product">
          </form>
        </div>
