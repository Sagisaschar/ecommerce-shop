    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <form action="{{ url('cms/menu') }}" method="POST" novalidate="novalidate">
          ...
          <input type="text" name="link" id="link" class="form-control field-input-cms original-text" value="{{ old('link') }}" placeholder="e.g. Gallery Diamonds">
            ...
            <div class="form-group">
              ...
              <input type="text" name="url" id="url" class="form-control field-input-cms target-text" value="{{ old('url') }}" placeholder="e.g. gallery-diamonds">
            ...
            <div class="form-group mb-5">
              ...
              <input type="text" name="title" id="title" class="form-control field-input-cms" value="{{ old('title') }}" placeholder="e.g. Gallery Diamonds">
          ...
          <a href="{{ url('cms/menu') }}" class="btn btn-outline-danger">Cancel</a>
            <input name="submit" class="btn btn-outline-primary" type="submit" value="Save Menu">
          </form>
        </div>
